          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                <Badge
                  variant="outline"
                  className="bg-cyan-950/50 text-cyan-300 border-cyan-700 flex items-center"
                >
              ...
              <div className="bg-black/40 border border-purple-900/50 rounded-lg p-6 mb-6">
                ...
                {course.url && (
                  ...
                  >
                    <Button
                      variant="outline"
                      className="border-purple-700 text-white hover:bg-purple-900/30"
                    >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-purple-300 text-sm">
                          Learn about the fundamentals and key concepts
                        </p>
                      </div>
                      <Badge
                        variant="outline"
            ...
            <Card className="bg-black/40 border-purple-900/50 sticky top-20">
              <CardContent className="p-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-purple-300 text-sm">
                    Take the quiz to earn your proof of learning
                  </p>
                </div>
